...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const particlesArray=[]; const PARTICLE_COUNT=120;
    ...
    function initParticles(){ for(let i=0;i<PARTICLE_COUNT;i++) particlesArray.push(new Particle()); }
